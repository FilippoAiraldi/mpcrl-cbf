...
python lti/eval.py scmpc --horizon=1 --dcbf --soft --terminal-cost=pwqnn --from-train=${training_results_filename} --n-eval=100 --save=${save_filename} --n-jobs=${number_of_parallel_jobs}
```
